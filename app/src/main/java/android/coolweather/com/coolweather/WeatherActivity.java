...
public class WeatherActivity extends AppCompatActivity {
    ...
    public static final String WEATHER_API_KEY = "c440406a1df9401aa4b22eeca9c88090";
    ...
    private void requestWeather(final String weatherId){
        String weatherUrl = "http://guolin.tech/api/weather?cityid=" + weatherId + "&key=" + WEATHER_API_KEY;
